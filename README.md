...
- Backport: Fix helm_release import dropping repository/values ([#1742](https://github.com/hashicorp/terraform-provider-helm/pull/1742)) - Preserves repository, values, and set* attributes during import
